          ...
          <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                    <a href="{{ route('inactive_users') }}" class="stretched-link text-reset text-decoration-none">
                      Pengguna Belum Aktif
                    </a>
                  </div>
                  <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jumlah_user_belum_aktif }}</div>
                </div>
                <div class="col-auto">
                  <a href="{{ route('inactive_users') }}"><i class="fas fa-users fa-2x text-gray-300"></i></a>
                </div>
              </div>
            </div>
          </div>
