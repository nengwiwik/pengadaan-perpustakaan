                  ...
                  <form class="user" method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user @error('email') is-invalid @enderror"
                        ...
                        value="{{ $email ?? old('email') }}" autofocus autocomplete="off">
                      @error('email')
                    ...
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user @error('password') is-invalid @enderror"
                        id="exampleInputpassword" aria-describedby="passwordHelp" placeholder="New password" name="password"
                    ...
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user @error('password_confirmation') is-invalid @enderror"
                        id="exampleInputpassword_confirmation" aria-describedby="password_confirmationHelp" placeholder="Confirm password" name="password_confirmation"
                        value="{{ old('password_confirmation') }}" autofocus autocomplete="off">
                    ...
                    <button type="submit" class="btn btn-primary btn-user btn-block">
                      <i class="fas fa-sign-out "></i> {{ __('Reset Password') }}
                    </button>
                  </form>
                </div>
              </div>
